...
label_3 = tk.Label(root, text="Link Bukalapak")
label_3.pack()
entry_3 = tk.Entry(root)
entry_3.pack()

label_4 = tk.Label(root, text="Selector bukalapak")
label_4.pack()
...
def print_input(input_1, input_2, input_selector_2_bk, input_selector_3_bk, input_selector_4_bk, input_3, input_4):
    global link_produk_1, input_selector_h1, input_selector_2_bukalapak, input_selector_3_bukalapak, input_selector_4_bukalapak,link_produk_2 ,input_selector_h2
...
def program2():
    ...
    for link in link_produk_2:
        ...
        try:
            wait = WebDriverWait(driver, 20)
            judul_produk = wait.until(EC.presence_of_element_located((By.CSS_SELECTOR, input_selector_h2))).text
        except NoSuchElementException:
            pass
        produk = {
            "links": link,
...
def start_scraping():
    print_input(entry_1.get(), entry_2.get(),entry_selector_2_bk.get(),entry_selector_3_bk.get(),entry_selector_4_bk.get(),entry_3.get(), entry_4.get())
    scraping()
