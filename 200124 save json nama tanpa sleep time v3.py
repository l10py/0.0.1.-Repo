...
def print_input(input_1, input_2, input_3, input_4,input_5,input_6,input_selector_2_bk):
...
#
    global input_selector_2_bukalapak
    input_selector_2_bukalapak = input_selector_2_bk
    print(input_selector_2_bukalapak)
##
...
def start_scraping():
    print_input(entry_1.get(), entry_2.get(),entry_3.get(), entry_4.get(),entry_5.get(),entry_6.get(),entry_selector_2_bk)
    scraping()
